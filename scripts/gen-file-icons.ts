...
// describes them. The framework overlays are included because they are indexed
// by filename too — \`fileIconName\` consults them *before* the plain tables, so
// an inherited property there answers first.
for (const table of [
  EXTENSION_ICONS,
  FILENAME_ICONS,
  FOLDER_ICONS,
